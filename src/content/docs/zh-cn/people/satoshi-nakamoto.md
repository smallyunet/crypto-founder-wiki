---
title: 中本聪（Satoshi Nakamoto）
description: Bitcoin 化名创始人的可验证活动、身份假说、早期持币估计、退出过程与证据边界档案。
pageType: person
...
:::note[独立复核结论]
“中本聪”是一个能够由白皮书、邮件、代码和早期链上活动确认的作者身份，但不是已经完成现实身份核验的自然人。公开证据无法可靠确认其姓名、性别、国籍、出生日期、家庭背景，甚至不能排除由多人共同使用化名的可能。本站将可验证作品与身份猜测严格分开。
:::

<figure class="profile-figure">
  <img src="/crypto-founder-wiki/images/people/satoshi-nakamoto.webp" alt="布达佩斯中本聪纪念雕像，人物戴兜帽且面部为镜面" width="720" height="900" loading="eager" fetchpriority="high" />
  <figcaption>布达佩斯 Graphisoft Park 的中本聪纪念雕像，面部刻意设计为无法识别的镜面；这不是中本聪本人肖像。Fekist 摄，来自 <a href="https://commons.wikimedia.org/wiki/File:Bust_of_Satoshi_Nakamoto_in_Budapest.jpg">Wikimedia Commons</a>，采用 <a href="https://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA 4.0</a>；本站裁切、缩放并转换为 WebP。</figcaption>
</figure>
...
**A 级**为原始邮件、代码、链上记录或法院判决；**B 级**为有来源链的早期参与者记录；**C 级**为可复现但依赖假设的统计归因；**D 级**为无法认证的自填资料或纯间接猜测。

## 能够确认的创立记录

### 白皮书与软件

2008年10月31日，署名 Satoshi Nakamoto 的作者在 Cryptography 邮件列表发布 *Bitcoin: A Peer-to-Peer Electronic Cash System*。原始邮件提出无需可信第三方的点对点电子现金，并说明以类似 Hashcash 的工作量证明同时完成发行和防止双花。[原始邮件列表记录](https://www.metzdowd.com/pipermail/cryptography/2008-October/014810.html)、[Bitcoin 白皮书](https://bitcoin.org/bitcoin.pdf)
...
2024—2026年的几轮高调调查分别指向 Peter Todd、Adam Back，以及 Hal Finney/Len Sassaman 组合，结论彼此冲突。WIRED 对这些调查的复盘指出，候选筛选和语言分析很容易形成确认偏误；没有一项公开材料建立了决定性的密码学证据。[WIRED 复盘](https://www.wired.com/story/you-found-satoshi-lets-see-the-receipts/)

### Craig Wright 的法律结论

2024年，英格兰和威尔士高等法院在 COPA v Wright 案中作出明确宣告：Craig Wright 不是使用 Satoshi Nakamoto 化名的人，不是 Bitcoin 系统创建者，不是白皮书作者，也不是原始 Bitcoin 软件作者。主判决详细审查了文档伪造、元数据和证人证据；后续禁令限制其继续作出相反主张。[英国司法机构主判决](https://www.judiciary.uk/judgments/copa-v-wright/)、[后续救济判决](https://www.bailii.org/ew/cases/EWHC/Ch/2024/1809.html)
...
1. [Cryptography 邮件列表：Bitcoin P2P e-cash paper](https://www.metzdowd.com/pipermail/cryptography/2008-October/014810.html)
2. [Bitcoin 原始白皮书](https://bitcoin.org/bitcoin.pdf)
3. [Cryptography 邮件列表：Bitcoin v0.1 released](https://www.metzdowd.com/pipermail/cryptography/2009-January/014994.html)
4. [Hal Finney：Bitcoin and me](https://bitcointalk.org/index.php?topic=155054.0)
5. [Mike Hearn：与中本聪通信的证人陈述](https://bitcoindefense.org/assets/documents/First-Witness-Statement-of-Michael-Christopher-Hearn.pdf)
