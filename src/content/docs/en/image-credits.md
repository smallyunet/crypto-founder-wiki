---
title: Image credits
description: Sources, authors, licenses, and modification notes for portraits and network marks used by Crypto Founder Wiki.
pageType: policy
---
...
| File | Person | Author/source | License | Changes made |
| --- | --- | --- | --- | --- |
...
| File | Network | Author/source | License |
| --- | --- | --- | --- |
...
- Images are used for identification and do not imply endorsement by the creator, photographer, or represented organization.
- Search-engine thumbnails and press photographs are not treated as freely reusable assets.
